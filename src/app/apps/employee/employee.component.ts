...
export class EmployeeComponent implements AfterViewInit {
  ...
  openDialog(action: string, obj: any): void {
    obj.action = action;
    const dialogRef = this.dialog.open(EmployeeDialogContentComponent, {
      data: obj,
    });
...
export class EmployeeDialogContentComponent {
  action: string;
  // tslint:disable-next-line - Disables all
  local_data: any;
  selectedImage: any = '';
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<EmployeeDialogContentComponent>,
