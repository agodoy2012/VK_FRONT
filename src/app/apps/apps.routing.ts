...
export const AppsRoutes: Routes = [
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            data: {
              title: 'New Email',
              urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Email' }],
            },
          },
        ],
        data: {
      ...
      },
      {
        ...
        data: {
          title: 'Notes',
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Notes' }],
        },
      },
      {
        path: 'ticketlist/:id',
        ...
        data: {
          title: 'Ticket List',
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Ticket List' }],
        },
      },
      {
        path: 'ticketlist/:id/:tab',
        component: TicketlistComponent,
        data: {
          title: 'Ticket List',
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Ticket List' }],
      ...
      },
      {
        ...
        data: {
          ...
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Ticket Details' }],
        },
      },
      {
        path: 'employeelist',
        ...
        data: {
          title: 'Employee List',
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Employee List' }],
        },
      },
      {
        path: 'contact/:id',
        ...
        data: {
          title: 'Contact',
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Contact' }],
        },
      },
      {
        path: 'courses',
        ...
        data: {
          title: 'Courses',
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Courses' }],
        },
      },
      {
      ...
      },
      {
        ...
        data: {
          title: 'View Invoice',
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'View Invoice' }],
        },
      },
      {
        path: 'editinvoice/:id',
