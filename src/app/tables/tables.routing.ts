...
export const TablesRoutes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        data: {
          title: 'Filter Table',
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Filter Table' }],
        },
      },
      {
        path: 'pagination',
        ...
        data: {
          ...
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Pagination Table' }],
        },
      },
      {
        path: 'sortable',
        ...
        data: {
          title: 'Sortable',
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Sortable' }],
        },
      },
     
      {
        ...
        data: {
          title: 'Dynamic Table',
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Dynamic Table' }],
        },
      },
      {
        path: 'expand-table',
        ...
        data: {
          title: 'Expand Table',
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Expand Table' }],
        },
      },
      {
        ...
        data: {
          ...
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Footer row Table' }],
        },
      },
      {
        ...
        data: {
          ...
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Multiple Header Footer' }],
        },
      },
      {
        path: 'http-table',
        ...
        data: {
          title: 'HTTP Table',
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'HTTP Table' }],
        },
      },
      {
        ...
        data: {
          ...
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Row Context Table' }],
        },
      },
      {
        ...
        data: {
          ...
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Selection Table' }],
        },
      },
      {
        ...
        data: {
          ...
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Sticky Column Table' }],
        },
      },
      {
